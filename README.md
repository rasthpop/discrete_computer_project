...
* алгоритм А*
#### Аліна Боднар:
* алгоритм А*, написання фінального звіту
...
* Використовуємо чергу з пріоритетами ```(PriorityQueue)```, щоб вибирати вершину із найменшою поточною відстанню.
 ...
 ![Alt text](/Users/alina/Desktop/screenshot1.png)
...
1.	Вибирається вершина із найменшою поточною відстанню ```(current_node)```.
2.	Якщо вершина вже відвідана, ми її пропускаємо.
3.	Додаємо вершину до множини ```visited_nodes```.

![alt text](<Picture 3.png>)

Для кожної сусідньої вершини adjacent_node виконуємо перевірку:
...
* Якщо нова відстань менша за ту, яка була записана раніше, оновлюємо цю відстань у словнику ```node_disctances``` та записуємо попередній вершину у ```graph_for_path_restoration```.
...
Після завершення основного циклу ми маємо словник ```graph_for_path_restoration```, тобто інформацію про попередні вершини для відновлення шляху. Ми також маємо довжину найкоротшого шляху до кінцевої вершини.
...
Алгоритм А* працює дуже схоже на Дейкстру, але використовує додаткову оцінку, яка допомагає передбачити, наскільки близька вершинадо кінцевої точки. Це допомагає алгоритму працювати швидше, оскільки він більше фокусується на тих вершинах, які ведуть до бажаної точки. Завдяки цьому А* часто шукає найкоротший шлях швидше, ніж Дейкстра.
...
## Наша реалізація алгоритму в Python
### Імпорти та бібліотеки:
Такі самі, к в алгоритмі Дейкстри, окрім нової бібліотеки time для вимірювання часу виконання функцій.
...
Далі так само, як в алгоритмі Дейкстри, ми створили клас ```PriorityQueue``` для реалізації черги з пріоритетами. Ця черга допомагає ефективно вибирати наступну вершину для обробки.
...
### Дейкстра:
Кількість відвіданих вузлів: 261279
Час виконання алгоритму Дейкстри: 0.356368 секунд
Загальний час виконання програми: 54.187821 секунд

### A:*
Кількість відвіданих вузлів: 122364
Час виконання алгоритму A*: 0.212818 секунд
Загальний час виконання програми: 55.140640 секунд

### Порівняння алгоритмів:
#### Час виконання:
Алгоритм A* показав швидший час виконання безпосередньо для пошуку шляху — 0.212818 секунд, що є помітно швидше, ніж у Дейкстри (0.356368 секунд).
Однак загальний час виконання програми в A* (55.140640 секунд) трохи більший за загальний час виконання програми в Дейкстри (54.187821 секунд). Це може бути через додаткові обчислення, пов'язані з оцінкою відстані до кінцевої точки, що використовується в A*.
